...
public class ShowFiltroConsultaRelMKTCategoriaAssinantesOptIn extends ShowAction {
	...
	public void updateVelocityContext(
		...
		throws Exception 
		{
			...
			{
				logger.error("Não foi possível realizar a consulta de relatório de markting Categoria dos assiantes do Opt-in, problemas na conexão com o banco de dados (" +
							pe.getMessage() + ")");
				throw pe;
			}
