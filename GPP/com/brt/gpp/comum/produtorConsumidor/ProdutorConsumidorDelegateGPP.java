 ...
 *
 */
public class ProdutorConsumidorDelegateGPP extends ProdutorConsumidorDelegate
{
	 ...
	 */
	public ProdutorConsumidorDelegateGPP(long idProcessamento)
	{
		gerLog 					= GerentePoolLog.getInstancia(getClass());
	 ...
	 */
	public ProdutorConsumidorDelegateGPP(long idProcessamento, int tempoEspera)
	{
		super(tempoEspera);
		gerLog 					= GerentePoolLog.getInstancia(getClass());
		this.idProcessamento 	= idProcessamento;
	...
	protected void handleException(Exception e)
	{
		...
		ProcessoBatchProdutor p = (ProcessoBatchProdutor) getProdutor();
		p.setStatusProcesso(Definicoes.TIPO_OPER_ERRO);
		p.handleException();
	}
	...
	public long exec (int qtdConsumidor, ProcessoBatchProdutor produtor, String[] params, Class consumidor) throws Exception
	{
		...
		try
		{
			...
			// esse tratamento
	    	inicializaConsumidores(qtdConsumidor,consumidor, this);
		...
		finally
		{
			...
			ap.gravaHistoricoProcessos(produtor.getIdProcessoBatch()
									  ...
									  ,(produtor.getDataProcessamento() != null) ? produtor.getDataProcessamento() : GPPData.dataFormatada()
									  );
		}
		return contGeral;
	}
