...
function validacpf (campo) {
  ...
  {
  	alert ('O CPF está incorreto. Favor corrigir!');
  }
}
...
/*
*  Função que valida se o campo de MSISDN foi preenchido corretamente (10 números)
*  Para utilização em: 
*    - filtroAjusteCredito.vm
*    - filtroAjusteDebito.vm
*    - filtroConsultaComprovanteServico.vm
...
function validaMsisdn(msisdn)
{
  ...
  {
    alert('O Número de Acesso está incompleto. Favor Corrigir! (DDD + Número)');
    return false;
  }
  return true;
}
