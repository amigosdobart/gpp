...
/**
 * Mostra a tela de consulta de relatorio Modelos na Base
 * 
 * @author Rafael Palladino
 * @since 14/12/2004
 */
public class ShowFiltroConsultaRelMKTModelosBaseAction extends ShowAction {
	...
	public String getTela() {
		return "filtroConsultaRelMKTModelosBase.vm";
	}
