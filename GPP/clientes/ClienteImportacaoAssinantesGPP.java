...
public class ClienteImportacaoAssinantesGPP
{
	public ClienteImportacaoAssinantesGPP ( )
	{
	}
	...
	public static void main(String[] args) 
	{
		...
		try
		{		
			retValue = pPOA.importaAssinantes();
			if (retValue == 0)
		...
		{
			System.out.println ("Metodo remoto de importacao de Assinantes executado com erro...");
