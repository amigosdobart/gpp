...
import com.brt.clientes.form.processosBatch.ProcBatchEnvioConsolidacaoSCRGPPForm;
 ...
 * @since 17/06/2004
 */
public class ConsultaProcBatchEnvioConsolidacaoSCRGPPAction extends ActionPortal {
	...
	public ActionForward performPortal(ActionMapping mapping, ActionForm form,
			...
			throws Exception {
		ProcBatchEnvioConsolidacaoSCRGPPForm procBatchForm = (ProcBatchEnvioConsolidacaoSCRGPPForm)form;
	  	procBatchForm.setResultado (ProcessosBatchGPP.doProcBatchEnvioConsolidacaoSCRGPP(procBatchForm.getDataExecucao()));
