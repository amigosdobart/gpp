...
/**
 * Este arquivo contem a definicao da classe de EnvioUsuariosRechargeExpiredProdutor.
 * Responsável pela seleção dos usuários que entraram no status RECHARGE_EXPIRED 
...
public class EnvioUsuariosRechargeExpiredProdutor extends Aplicacoes implements ProcessoBatchProdutor
{
	...
	public EnvioUsuariosRechargeExpiredProdutor (long logId)
	{
		  super(logId, Definicoes.CL_ENVIO_USUARIO_RECHARGE_EXPIRED);
	}
	...
	public void startup(String params[]) throws Exception
	{
		...
		// assinantes que entram no status RECHARGER_EXPIRED. O resultSet é atualizado ficando 
		...
		// Seleciona os usuários que passaram de normal para recarga expirada
		String sql = 
			" SELECT HOJE.MSISDN,                                                   " +
		...
		Object param[] = {new Integer(Definicoes.RECHARGE_EXPIRED)
						 ,dataProcessamento
	...
	{
		return Definicoes.IND_USUARIO_RECHARGE_EXPIRED ;
	}
	...
	public String getDescricaoProcesso()
	{
		if(getStatusProcesso().equals(Definicoes.PROCESSO_SUCESSO))
			return "Foram registrados " + numRegistros + " XMLs de usuarios em RechargeExpired em todas promoções.";
		return "Erro ao executar extracao de usuarios em status de RECHARGE EXPIRED.";
	}
