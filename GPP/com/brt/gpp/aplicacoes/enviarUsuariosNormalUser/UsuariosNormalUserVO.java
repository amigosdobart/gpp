 ...
 * que define os dados passados sobre os usuários em Normal User
 * 
...
public class UsuariosNormalUserVO
{
	 ...
	 * @param data
	 */
	public UsuariosNormalUserVO(String msisdn, int idtPlanoPreco, int idtPromocao, String data)
	{
		this.msisdn = msisdn;
