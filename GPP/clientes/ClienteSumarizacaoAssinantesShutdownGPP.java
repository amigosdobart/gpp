...
public class ClienteSumarizacaoAssinantesShutdownGPP
{
	...
	public static void main(String[] args) 
	{
		...
		try
		{		
			pPOA.sumarizaAssinantesShutdown(args[2]);
			System.out.println ("Metodo remoto sumarizaAssinantesShutdown executado com sucesso...");
		}
		catch (Exception e) 
		{
			System.out.println ("Metodo remoto sumarizaAssinantesShutdown executado com erro...");
