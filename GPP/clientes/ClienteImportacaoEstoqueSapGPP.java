...
public class ClienteImportacaoEstoqueSapGPP{
	public ClienteImportacaoEstoqueSapGPP ( )
	{
	}
	...
	public static void main(String[] args) 
	{
		...
		try
		{		
			retValue = pPOA.importaEstoqueSap();
			if (retValue == 0)
		...
		{
			System.out.println ("Metodo remoto de importacao da informacoes de ESTOQUE-SAP executado com erro...");
