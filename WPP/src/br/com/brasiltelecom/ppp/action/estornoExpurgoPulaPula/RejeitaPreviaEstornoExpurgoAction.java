...
/**
 * 
 * Rejeita lote de Estorno/Expurgo de Bonus Pula-Pula.
 * 
 * @author Bernardo Vergne Dias
 * @since 20/12/2006
 */
public class RejeitaPreviaEstornoExpurgoAction extends ActionPortal 
{
	private String codOperacao = Constantes.COD_REJEITAR_PREVIA;
	
	Logger logger = Logger.getLogger(this.getClass());
	
	/**
	 * Método principal da classe, reponsável pela rejeição do lote
	 * 
			...
			HttpServletResponse response, Database db) throws Exception 
	{
		...
		{	
			...
			EstornoExpurgoPulaPulaHome.rejeitarLote(servlet, request.getParameter("lote"));
			mensagem = "Lote '" + request.getParameter("lote") + "' rejeitado com sucesso!";	
			...
			{
				logger.error("Erro ao gerar o arquivo de histórico de rejeição de prévia. " + e.getMessage());	
		...
		{
			logger.error("Erro ao rejeitar lote de Estorno/Expurgo PulaPula");	
			mensagem = "Erro ao rejeitar lote de Estorno/Expurgo Pula-Pula";
			result = actionMapping.findForward("error");
		} 
