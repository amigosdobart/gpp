...
/**
 * Mostra a tela de filtro de consulta de assinante
 * @author Alex Pitacci Simões
 * @since 04/06/2004
 */
public class ShowFiltroConsultaAssinanteAction extends ShowAction {
	...
	public String getTela() {
		return "filtroAprovisionamentoConsultaAssinante.vm";
	}
