 ...
 * @since 14/05/2005
 */
public class ShowFiltroConsultaRelFINTrafegoEFinanceiroCSPAction extends ShowAction {

	private String codOperacao = Constantes.MENU_FIN_TRAF_E_FIN_CSP;
	...
	public String getTela() {
		return "filtroConsultaRelFINTrafegoEFinanceiroCSP.vm";
	}
	...
	public void updateVelocityContext(
		...
		throws Exception {
			...
			{
				logger.error("Não foi possível realizar a consulta de relatório de Tráfego E Financeiro por CSP, problemas na conexão com o banco de dados (" +
								pe.getMessage() + ")");
				throw pe;
			}
	}
