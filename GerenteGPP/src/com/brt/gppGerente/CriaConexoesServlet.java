...
public class CriaConexoesServlet extends HttpServlet
{
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)	throws ServletException, IOException 
	{
		...
		try
		{
			...
			if ( pPOA.criaConexao( tipoPool ) )
				msg = "Conexão no pool de conexões " + nomePool + ", foi criada com sucesso.";
			else
				msg = "Não foi possível criar conexão no pool de conexões " + nomePool + ".";
		}
