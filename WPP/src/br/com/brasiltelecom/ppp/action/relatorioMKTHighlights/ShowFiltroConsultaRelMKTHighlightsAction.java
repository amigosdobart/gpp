...
/**
 * Mostra a tela de consulta de relatorio Highlights TSD
 * 
 * @author Rafael Palladino
 * @since 14/12/2004
 */
public class ShowFiltroConsultaRelMKTHighlightsAction extends ShowAction {
	...
	public String getTela() {
		return "filtroConsultaRelMKTHighlights.vm";
	}
