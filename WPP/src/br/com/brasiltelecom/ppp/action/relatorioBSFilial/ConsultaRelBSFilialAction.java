...
/**
 * Gera o relatório de BS por filial
 * 
 * @author André Gonçalves
 * @since 21/05/2004
 */
public class ConsultaRelBSFilialAction extends ActionPortal {
	...
	public ActionForward performPortal(
				...
				logger.info("Consulta por relatório de BS/filial solicitada");
				...
				request.setAttribute(Constantes.MENSAGEM, "Consulta ao relatório de BS por filial realizada com sucesso!");
				this.codOperacao = Constantes.COD_CONSULTA_BS_FILIAL;
				...
				String endereco = "../reports/rwservlet?ppp+BSFilialStatus.rdf+"+request.getParameter("DESFORMAT")+"+datai="+sdf.format(dataInicial)+"+dataf="+sdf.format(dataFinal)+"+CANAL="+request.getParameter("CANALORIGEM");
				if (request.getParameter("DESFORMAT").equals("DELIMITED"))
					endereco = "./rep2excel?relatorioXSL=./dtd/Relatorio_BS_Filial_Status.xsl&relatorioXML="+endereco.replaceFirst("DELIMITED","XML");
