...
/**
 * Mostra a tela de filtro do friends and family
 * @author Alex Pitacci Simões
 * @since 04/06/2004
 */
public class ShowFiltroFriendsFamilyAction extends ShowAction {
	...
	public String getTela() {
		return "filtroAprovisionamentoFriendsFamily.vm";
	}
