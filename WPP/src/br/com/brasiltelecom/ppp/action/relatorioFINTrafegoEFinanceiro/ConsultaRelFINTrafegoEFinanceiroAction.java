 ...
 */
package br.com.brasiltelecom.ppp.action.relatorioFINTrafegoEFinanceiro;
...
/**
 * Gera o relatório de Ativação de Tráfego e Financeiro
 * 
 * @author Marcos C. Magalhães
 * @since 13/06/2005
 */

public class ConsultaRelFINTrafegoEFinanceiroAction extends ActionPortal {
	...
	public ActionForward performPortal(
				...
				logger.info("Consulta por relatório de Tráfego e Financeiro");
				...
				request.setAttribute(Constantes.MENSAGEM, "Consulta ao relatório de Tráfego e Financeiro realizada com sucesso!");
				this.codOperacao = Constantes.COD_CONSULTAR_TRAFEGO_E_FINAN;
				...
				String endereco = "../reports/rwservlet?ppp+FINTrafegoEFinanceiro.rdf+"+request.getParameter("DESFORMAT")+"+dataInicial="+formatoDDMMMYYYY.format(dataInicial)+"+dataFinal="+formatoDDMMMYYYY.format(dataFinal)+"+P_CN="+request.getParameter("P_CN") /*+"+CANAL="+request.getParameter("CANALORIGEM")*/;
