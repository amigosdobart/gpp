...
import com.brt.clientes.form.processosBatch.ProcBatchSumarizacaoProdutoPlanoForm;
 ...
 * @since 17/06/2004
 */
public class ConsultaProcBatchSumarizacaoProdutoPlanoAction
		extends
			ActionPortal {
	...
	public ActionForward performPortal(ActionMapping mapping, ActionForm form,
		...
		ProcBatchSumarizacaoProdutoPlanoForm procBatchForm = (ProcBatchSumarizacaoProdutoPlanoForm)form;
		  procBatchForm.setResultado
		    (ProcessosBatchGPP.doProcBatchSumarizacaoProdutoPlano( procBatchForm.getDataExecucao() ));
