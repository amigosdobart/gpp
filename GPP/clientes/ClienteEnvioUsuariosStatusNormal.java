 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class ClienteEnvioUsuariosStatusNormal {
	...
	public static void main(String[] args) 
	{
		...
		try
		{	
			pPOA.enviarUsuariosStatusNormal(args[2]);
			System.out.println ("Metodo remoto enviaUsuariosStatusNormal executado com sucesso...");
		}
		catch (Exception e) 
		{
			System.out.println ("Metodo remoto enviaUsuariosStatusNormal executado com erro...");
...
//		int userOption;
		System.out.println ("\n\n");
		System.out.println ("+----------------------------------------------------+");
		System.out.println ("+  Sistema de Teste de Envio de Usuarios Status Normal  +");
		System.out.println ("+----------------------------------------------------+\n");
