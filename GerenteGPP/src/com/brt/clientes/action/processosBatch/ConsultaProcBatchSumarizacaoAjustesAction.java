...
import com.brt.clientes.form.processosBatch.ProcBatchSumarizacaoAjustesForm;
 ...
 * @since 17/06/2004
 */
public class ConsultaProcBatchSumarizacaoAjustesAction extends ActionPortal {
	...
	public ActionForward performPortal(ActionMapping mapping, ActionForm form,
			...
			throws Exception {
		ProcBatchSumarizacaoAjustesForm procBatchForm = (ProcBatchSumarizacaoAjustesForm)form;
		  procBatchForm.setResultado
		    (ProcessosBatchGPP.doProcBatchSumarizacaoAjustes(procBatchForm.getDataExecucao()));
