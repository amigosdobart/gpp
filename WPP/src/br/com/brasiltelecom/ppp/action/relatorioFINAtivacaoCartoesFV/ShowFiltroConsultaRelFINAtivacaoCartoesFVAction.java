 ...
 * @since 10/05/2005
 */
public class ShowFiltroConsultaRelFINAtivacaoCartoesFVAction extends ShowAction {

	private String codOperacao = Constantes.MENU_FIN_ATIV_CART_FV;
	...
	public String getTela() {
		return "filtroConsultaRelFINAtivacaoCartoesFV.vm";
	}
	...
	public void updateVelocityContext(
		...
		throws Exception {
			...
			{
				logger.error("Não foi possível realizar a consulta de relatório de Ativação de Cartões Físico Virtuais, problemas na conexão com o banco de dados (" +
								pe.getMessage() + ")");
				throw pe;
			}
	}
