...
import com.brt.clientes.form.processosBatch.ProcBatchEnvioUsuariosStatusNormalForm;
 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ConsultaProcBatchEnvioUsuariosStatusNormalAction extends ActionPortal {
			...
			HttpServletRequest request, HttpServletResponse response) throws Exception 
  {
  	...
  	ProcBatchEnvioUsuariosStatusNormalForm procBatchForm = (ProcBatchEnvioUsuariosStatusNormalForm)form;
  	procBatchForm.setResultado
	  (ProcessosBatchGPP.doProcBatchEnvioUsuariosStatusNormal
