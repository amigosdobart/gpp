...
/**
 * DAO para consulta da view ContestacaoChamadas.
 * 
 * @author Bernardo Dias
 * Data: 31/01/2008
 */
public class ContestacaoChamadasDAO
{
	
	/**  
	 * Consulta uma lista de ContestacaoChamadas de acordo com os criterios.
	 *   
	...
	{
        Criteria criteria = session.createCriteria(com.brt.gpp.comum.mapeamentos.entidade.ContestacaoChamadas.class);
