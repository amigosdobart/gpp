 ...
 * @since 04/12/2007
 */
public class ShowFiltroConsultaSubidaTSDAction extends ShowActionHibernate 
{	    
	
	private String codOperacao = Constantes.MENU_REL_SUBIDA_TSD;	
	...
	{
		return "filtroConsultaSubidaTSD.vm";
	}
