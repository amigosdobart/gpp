...
public class ClienteIndiceBonificacao 
{
	public static void main(String[] args) 
	{
		...
		try
		{		
			pPOA.calcularIndiceBonificacao(args[2]);
			System.out.println ("Metodo remoto ClienteIndiceBonificacao executado com sucesso...");
		}
		catch (Exception e) 
		{
			System.out.println ("Metodo remoto ClienteIndiceBonificacao executado com erro...");
