 ...
 */
package br.com.brasiltelecom.ppp.action.relatorioFINAtivacaoCartoesFV;
...
public class ConsultaRelFINAtivacaoCartoesFVAction extends ActionPortal {
	...
	public ActionForward performPortal(
				...
				logger.info("Consulta por relatório de Ativação de Cartões Físicos Virtuais");
				...
				this.codOperacao = Constantes.COD_CONSULTAR_ATIV_CART_FV;
				...
				String endereco = "../reports/rwservlet?ppp+FINAtivacaoCartoesFisicosVirtuais.rdf+"+request.getParameter("DESFORMAT")+"+dataInicial="+formatoDDMMYYYY.format(dataInicial)+"+dataFinal="+formatoDDMMYYYY.format(dataFinal)+"+P_CN="+request.getParameter("P_CN")+"+categoria="+request.getParameter("categoria");
