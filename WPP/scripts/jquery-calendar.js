...
function PopUpCal()
{
	...
	this.regional[''] = { // Default regional settings
		...
		monthNames: ['Janeiro','Fevereiro','Março','Abril','Maio','Junho',
					 'Julho','Agosto','Setembro','Outubro','Novembro','Dezembro'], // Names of months
	...
	this._defaults =
	{	// Global defaults for all the calendar instances
		//autoPopUp: 'focus', // 'focus' for popup on focus,
		autoPopUp: 'button',  // 'button' for trigger button, or 'both' for either
		appendText: '', // Display text following the input box, e.g. showing the format
		buttonText: 'Clique para escolher uma data.', // Text for trigger button
		buttonImage: 'img/bt_calendario.gif', // URL for trigger button image
		...
		yearRange: '-15:+15', // Range of years to display in drop-down,
	...
	_connectCalendar: function(target, inst) {
		...
		if (autoPopUp == 'button' || autoPopUp == 'both') { // pop-up calendar when button clicked
			...
			var trigger = $(buttonImageOnly ? '<img class="calendar_trigger" src="' +
				...
				'<img src="' + buttonImage + '" style="cursor:pointer;vertical-align:text-top" alt="' + buttonText + '" title="' + buttonText + '"/>' :
							   buttonText) + '</button>');
