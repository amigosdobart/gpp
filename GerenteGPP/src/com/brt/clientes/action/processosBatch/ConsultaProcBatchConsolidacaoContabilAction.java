...
import com.brt.clientes.form.processosBatch.ProcBatchConsolidacaoContabilForm;
 ...
 * @since 17/06/2004
 */
public class ConsultaProcBatchConsolidacaoContabilAction extends ActionPortal {
	...
	public ActionForward performPortal(ActionMapping mapping, ActionForm form,
			...
			throws Exception {
		ProcBatchConsolidacaoContabilForm procBatchForm = (ProcBatchConsolidacaoContabilForm)form;
		  procBatchForm.setResultado
		    (ProcessosBatchGPP.doProcBatchConsolidacaoContabil(procBatchForm.getDataExecucao()));
