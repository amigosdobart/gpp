...
public class ClienteTratarVoucherGPP
{
	public ClienteTratarVoucherGPP ( )
	{
	}
	...
	public static void main(String[] args) 
	{
		...
		try
		{		
			pPOA.executaTratamentoVoucher(args[2]);
			System.out.println ("Metodo remoto executaTratamentoVoucher executado com sucesso...");
		}
		catch (Exception e) 
		{
			System.out.println ("Metodo remoto executaTratamentoVoucher executado com erro...");
...
//		int userOption;
		System.out.println ("\n\n");
		System.out.println ("+----------------------------------------------+");
		System.out.println ("+  Sistema de Teste de Tratamento de Voucher  +");
		System.out.println ("+----------------------------------------------+\n");
