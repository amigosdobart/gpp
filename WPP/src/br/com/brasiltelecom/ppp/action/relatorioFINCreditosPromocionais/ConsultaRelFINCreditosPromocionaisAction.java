...
/**
 * Gera o relatório de Créditos Promocionais
 * 
 * @author Marcos C. Magalhães
 * @since 14/06/2005
 */

public class ConsultaRelFINCreditosPromocionaisAction extends ActionPortal {
	...
	public ActionForward performPortal(
				...
				logger.info("Consulta por relatório de Créditos Promocionais");
				...
				request.setAttribute(Constantes.MENSAGEM, "Consulta ao relatório de Créditos Promocionais realizada com sucesso!");
				this.codOperacao = Constantes.COD_CONSULTAR_CREDITOS_PROM;
				...
				String endereco = "../reports/rwservlet?ppp+FINCreditosPromocionais.rdf+"+request.getParameter("DESFORMAT")+"+dataInicial="+formatoDDMMYYYY.format(dataInicial)+"+dataFinal="+formatoDDMMYYYY.format(dataFinal)+"+P_CN="+request.getParameter("P_CN")+"+categoria="+request.getParameter("categoria") /*+"+CANAL="+request.getParameter("CANALORIGEM")*/;
