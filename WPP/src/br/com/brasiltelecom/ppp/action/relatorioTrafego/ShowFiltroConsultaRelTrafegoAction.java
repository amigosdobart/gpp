...
/**
 * Mostra a tela de Filtro de Relatório de Tráfego
 * 
 * @author Jorge Abreu
 * @since 21/08/2007
 */
public class ShowFiltroConsultaRelTrafegoAction extends ShowActionHibernate 
{

	private String codOperacao = Constantes.MENU_REL_TRAFEGO;
	...
	{
		return "filtroConsultaRelTrafego.vm";
	}
