...
public class ClienteImportacaoCDRGPP
{
	public ClienteImportacaoCDRGPP ( )
	{
	}
	...
	public static void main(String[] args) 
	{
		...
		try
		{
			...
			retValue = pPOA.importaArquivosCDR(formatoData.format(new java.util.Date()));
			if (retValue == 0)
		...
		{
			System.out.println ("Metodo remoto de importacao de CDR executado com erro...");
